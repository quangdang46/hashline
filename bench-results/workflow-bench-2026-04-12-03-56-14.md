...
Date: 2026-04-12 03:56:14
Commit: `fdcc6a4`
Build: current working tree
Input: `workflow-results-2026-04-12-03-54-11.jsonl`
...
|---|---|---|---|---:|---:|
| `exact_match_single_edit` | edit_expected_target | edited expected target | edited expected target | 106.177 | 1.690 |
| `surrounding_drift_single_edit` | edit_expected_target | edited expected target | edited expected target | 110.461 | 1.480 |
| `target_drift_single_edit` | safe_rejection | safe rejection | safe rejection | 83.840 | 1.844 |
| `duplicate_target_single_edit` | edit_expected_target | edited expected target | unsafe wrong edit | 142.993 | 1.615 |
| `line_shift_single_edit` | safe_rejection | safe rejection | unsafe wrong edit | 60.954 | 1.742 |
