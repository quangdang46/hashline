...
Date: 2026-03-29 08:38:21
Commit: `501f538`
Build: current working tree
Input: `workflow-results-2026-03-29-08-38-10.jsonl`
...
|---|---|---|---|---:|---:|
| `exact_match_single_edit` | edit_expected_target | edited expected target | edited expected target | 585.870 | 1.436 |
| `surrounding_drift_single_edit` | edit_expected_target | edited expected target | edited expected target | 305.634 | 1.147 |
| `target_drift_single_edit` | safe_rejection | safe rejection | safe rejection | 85.842 | 1.173 |
| `duplicate_target_single_edit` | edit_expected_target | edited expected target | unsafe wrong edit | 250.840 | 1.540 |
| `line_shift_single_edit` | safe_rejection | safe rejection | unsafe wrong edit | 82.638 | 1.012 |
