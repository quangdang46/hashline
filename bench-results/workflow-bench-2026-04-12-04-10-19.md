...
Date: 2026-04-12 04:10:19
Commit: `fdcc6a4`
Build: current working tree
Input: `workflow-results-2026-04-12-04-10-13.jsonl`
...
|---|---|---|---|---:|---:|
| `exact_match_single_edit` | edit_expected_target | edited expected target | edited expected target | 74.597 | 4.086 |
| `surrounding_drift_single_edit` | edit_expected_target | edited expected target | edited expected target | 115.231 | 4.346 |
| `target_drift_single_edit` | safe_rejection | safe rejection | safe rejection | 75.613 | 5.010 |
| `duplicate_target_single_edit` | edit_expected_target | edited expected target | unsafe wrong edit | 84.869 | 1.822 |
| `line_shift_single_edit` | safe_rejection | safe rejection | unsafe wrong edit | 77.789 | 0.863 |
